...
Attacklab.wmdBase = function() {
	...
	_6.skin = function(_27, _28, _29, _2a) {
		...
		for ( var _2e = 0; _2e < 4; _2e++) {
			...
			if (_2c) {
				...
				_2b.backgroundPosition = (_2e & 2 ? "left" : "right") + " "
						+ (_2e & 1 ? "top" : "bottom");
			}
			_27.appendChild(_2f);
		}
	...
	_6.setImage = function(_35, _36, _37, _38) {
		...
		if (_5.userAgent.indexOf("MSIE") != -1) {
			...
			var _3a = _39.style;
			_3a.filter = "progid:DXImageTransform.Microsoft."
					+ "AlphaImageLoader(src='" + _36 + "')";
		} else {
			_35.src = _36;
		}
		return _35;
	...
	_6.createImage = function(_3b, _3c, _3d) {
		...
		if (_5.userAgent.indexOf("MSIE") != -1) {
			...
			_3f.height = "1px";
			_3f.width = "1px";
			_3f.filter = "progid:DXImageTransform.Microsoft."
					+ "AlphaImageLoader(src='" + _3b + "')";
			_40.unselectable = "on";
			_3e.appendChild(_40);
		} else {
	...
	_6.findPanes = function(_15d) {
		_15d.preview = _15d.preview
				|| _6.getElementsByClass("wmd-preview", null, "div")[0];
		_15d.output = _15d.output
				|| _6.getElementsByClass("wmd-output", null, "textarea")[0];
		_15d.output = _15d.output
				|| _6.getElementsByClass("wmd-output", null, "div")[0];
		if (!_15d.input) {
			var _15e = -1;
